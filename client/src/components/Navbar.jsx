      ...
      <div className="max-w-screen-xl mx-auto px-6 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-xl text-sm px-4 py-2 shadow-sm dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 transition-all"
          >
            Logout
          </button>
