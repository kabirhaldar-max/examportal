...
const CreateUser = () => {
  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-900 min-h-screen">
      ...
      >
        <h1 className="text-center text-3xl font-bold text-gray-900 dark:text-white py-6">
          Create New User
        </h1>
          ...
          <div className="relative flex flex-col gap-2 w-full">
            ...
            <div className="absolute right-3 top-14 transform -translate-y-1/2 flex gap-2">
              <button
                ...
                className="text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors duration-300 p-1 rounded"
              >
                <RefreshCw size={20} />
              </button>
              <button
            ...
            {examsData &&
              examsData.map((item) => (
                <CustomCheckbox
                  ...
                  className="backdrop-blur-sm bg-white/30 dark:bg-gray-800/40 p-4 rounded-xl shadow-md flex items-center justify-between text-gray-900 dark:text-white"
                />
              ))}
          </div>
        </div>
